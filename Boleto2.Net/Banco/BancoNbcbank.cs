...
[assembly: WebResource("BoletoNet.Imagens.753.jpg", "image/jpg")]

namespace Boleto2Net
{

    internal sealed class BancoNbcbank : IBanco
    {
        internal static Lazy<IBanco> Instance { get; } = new Lazy<IBanco>(() => new BancoNbcbank());

        public Cedente Cedente { get; set; }
        public int Codigo { get; } = 237;
        public string Nome { get; } = "BancoNbcbank";
        ...
        public void FormataCedente()
        {
            ...
            if (!CarteiraFactory<BancoNbcbank>.CarteiraEstaImplementada(contaBancaria.CarteiraComVariacaoPadrao))
                throw Boleto2NetException.CarteiraNaoImplementada(contaBancaria.CarteiraComVariacaoPadrao);

            contaBancaria.FormatarDados("ATÉ O VENCIMENTO EM QUALQUER BANCO. APÓS O VENCIMENTO SOMENTE NO NBCBANK.", "", "", 7);
        ...
        {
            var carteira = CarteiraFactory<BancoNbcbank>.ObterCarteira(boleto.CarteiraComVariacao);
